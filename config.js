const config = {
    ...
    "includedItems": [
      {
        ...
        "text": "Family passes to all rides and attractions"
      },
      {
        "icon": "fas fa-parking",
        "text": "Parking pass included for stress-free arrival"
      },
      {
        "icon": "fas fa-users",
        "text": "Ideal for families and young couples seeking adventure"
      },
      {
        "icon": "fas fa-clock",
        "text": "Valid for a limited time only"
      },
      {
        "icon": "fas fa-thumbs-up",
        "text": "Easy and fun entry process"
      }
    ],
  ...
  "entryForm": {
    "sharePlatforms": {
      "facebook": "https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgiveaway-611.netlify.app%2Fadmin",
      "twitter": "https://twitter.com/intent/tweet?url=https%3A%2F%2Fgiveaway-611.netlify.app%2Fadmin&text=Win%20a%20Family%20Day%20at%20Canada's%20Wonderland!%20Enter%20now!"
    },
